...
type keyStore interface {
	...
	GetKey(addr tron.Address, filename string, auth string) (*Key, error)
...
func newKeyFromECDSA(privateKeyECDSA *ecdsa.PrivateKey) *Key {
	...
	key := &Key{
		ID:         id,
		Address:    tron.PublicKeyToAddress(privateKeyECDSA.PublicKey),
...
func keyFileName(keyAddr tron.Address) string {
	ts := time.Now().UTC()
