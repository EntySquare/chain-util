...
func (ks *KeyStore) HasAddress(addr tron.Address) bool {
...
func (ks *KeyStore) Lock(addr tron.Address) error {
	ks.mu.Lock()
...
func (ks *KeyStore) expire(addr tron.Address, u *unlocked, timeout time.Duration) {
